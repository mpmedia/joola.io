...
exports.qlen = {
  name: "/api/system/qlen",
  description: "I print the current queue length on the node",
  inputs: {
    required: [],
    optional: ['uid']
  },
